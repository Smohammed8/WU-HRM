...

{
    ...
    // {
    //     return [
    //         ['Jimma University ID No', 'Full Name', 'Gender', 'Date Of Birth', 'Citizenship', 'Place Of Birth', 'Contact Information',   'Work Experience', 'Family Status', 'Education Level', 'If Specialized or Subspecialized', 'Academic Rank', 'Staff Category', 'Field Of Study', 'Institute College', 'Facultie', 'Department',   'Current Duty Status',   'If Study Leave',   'Empolyeement Status', 'Position',   'Work Load Recent Semester',   'Monthly Income',   'House Service Provision', 'Expected Retirement Year'],
    ...
    public function headings(): array
    {
        return [
            [
                ...
                'Phone No',
                'Disability',
                'Employment year (DD/MM/YYYY)',
                'Service Year under Other Org',
                'Service Year under JU',
                'Total Service Year',
                'Marital Status',
                'No Children',
                'Education Level',
                ...
                'Empolyeement Status',
                'Basic Salary',
                'House Allowance (If in Cash Amount) or In Kind',
                'Position Allowance', 'Duty (for Health)',
