...
use App\Http\Requests\TypeOfLeaveRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use Illuminate\Support\Facades\Route;
/**
 * Class TypeOfLeaveCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class TypeOfLeaveCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\TypeOfLeave::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/type-of-leave');
        CRUD::setEntityNameStrings('type of leave', 'type of leaves');
        $this->setupPermission();
    }

    public function setupPermission()
    {
        $permission_base = 'type_of_leave';
    ...
    {
        CRUD::setValidation(TypeOfLeaveRequest::class);
