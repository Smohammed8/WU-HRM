...
use App\Http\Requests\TypeOfMisconductRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use Illuminate\Support\Facades\Route;
/**
 * Class TypeOfMisconductCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class TypeOfMisconductCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\TypeOfMisconduct::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/type-of-misconduct');
        CRUD::setEntityNameStrings('type of misconduct', 'type of misconducts');
    ...
    {
        CRUD::setValidation(TypeOfMisconductRequest::class);
