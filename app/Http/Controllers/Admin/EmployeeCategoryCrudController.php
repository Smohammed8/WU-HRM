...
/**
 * Class EmployeeCategoryCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class EmployeeCategoryCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\EmployeeCategory::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/employee-category');
        CRUD::setEntityNameStrings('employee category', 'employee categories');
        $this->setupPermission();
    }

    public function setupPermission()
    {
        $permission_base = 'employee_category';
