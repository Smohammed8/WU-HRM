...
use App\Http\Requests\ApplicationTypeRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class ApplicationTypeCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class ApplicationTypeCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\ApplicationType::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/application-type');
        CRUD::setEntityNameStrings('application type', 'application types');
    ...
    {
        $permission_base = 'application_type';
    ...
    {
        CRUD::setValidation(ApplicationTypeRequest::class);
