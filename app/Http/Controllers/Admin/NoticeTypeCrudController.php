...
/**
 * Class NoticeTypeCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class NoticeTypeCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\NoticeType::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/notice-type');
        CRUD::setEntityNameStrings('notice type', 'notice types');
        $this->setupPermission();
    }
    public function setupPermission()
    {
        $permission_base = 'notice_type';
    ...
    {
        CRUD::setValidation(NoticeTypeRequest::class);
