...
use App\Http\Requests\HrBranchRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;
use Illuminate\Support\Facades\Route;

/**
 * Class HrBranchCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class HrBranchCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\HrBranch::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/hr-branch');
        CRUD::setEntityNameStrings('hr branch', 'hr branches');
    }

    public function setupPermission()
    {
        $permission_base = 'hr_branch';
