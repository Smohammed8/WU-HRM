...
/**
 * Class KebeleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class KebeleCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Kebele::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/kebele');
        CRUD::setEntityNameStrings('kebele', 'kebeles');
        $this->setupPermission();
    }

    public function setupPermission()
    {
        $permission_base = 'kebele';
    ...
    {
        CRUD::setValidation(KebeleRequest::class);

        CRUD::field('name');
        CRUD::field('woreda_id');
