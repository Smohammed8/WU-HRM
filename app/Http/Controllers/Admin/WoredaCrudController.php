...
/**
 * Class WoredaCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class WoredaCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Woreda::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/woreda');
        CRUD::setEntityNameStrings('woreda', 'woredas');
        $this->setupPermission();
    }

    public function setupPermission()
    {
        $permission_base = 'woreda';
    ...
    {
        CRUD::setValidation(WoredaRequest::class);
