...
use App\Http\Requests\FamilyRelationshipRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class FamilyRelationshipCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class FamilyRelationshipCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\FamilyRelationship::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/family-relationship');
        CRUD::setEntityNameStrings('family relationship', 'family relationships');
        $this->setupPermission();
    }

    public function setupPermission()
    {
        $permission_base = 'family_relationship';
    ...
    {
        CRUD::setValidation(FamilyRelationshipRequest::class);
