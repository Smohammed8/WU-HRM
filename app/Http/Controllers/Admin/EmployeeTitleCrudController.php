...
use App\Http\Requests\EmployeeTitleRequest;
use Backpack\CRUD\app\Http\Controllers\CrudController;
use Backpack\CRUD\app\Library\CrudPanel\CrudPanelFacade as CRUD;

/**
 * Class EmployeeTitleCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class EmployeeTitleCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\EmployeeTitle::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/employee-title');
        CRUD::setEntityNameStrings('employee title', 'employee titles');
        $this->setupPermission();
    }

    public function setupPermission()
    {
        $permission_base = 'employee_title';
    ...
    {
        CRUD::setValidation(EmployeeTitleRequest::class);

        CRUD::field('title');
        CRUD::field('accronomy');
