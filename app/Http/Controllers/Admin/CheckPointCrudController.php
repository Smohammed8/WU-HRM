...
class CheckPointCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/check-point');
        CRUD::setEntityNameStrings('check point', 'check points');
        $this->setupPermission();
    }
    public function setupPermission()
    {
        $permission_base = 'check_point';
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('unit_id')->label('Checkpoint office')->size(6);
        CRUD::field('order')->label('Clearance order')->size(6);
