...
/**
 * Class CertificationTypeCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class CertificationTypeCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\CertificationType::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/certification-type');
        CRUD::setEntityNameStrings('certification type', 'certification types');
    }
    public function setupPermission()
    {
        $permission_base = 'certification_type';
    ...
    {
        CRUD::setValidation(CertificationTypeRequest::class);
