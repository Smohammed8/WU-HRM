...
class EducationalLevelCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setRoute(config('backpack.base.route_prefix') . '/educational-level');
        CRUD::setEntityNameStrings('educational level', 'educational levels');
        $this->setupPermission();
    }

    public function setupPermission()
    {
        $permission_base = 'education_level';
    ...
    {
        CRUD::setValidation(EducationalLevelRequest::class);

        CRUD::field('name')->size(6);
        CRUD::field('weight')->type('number')->size(6);
