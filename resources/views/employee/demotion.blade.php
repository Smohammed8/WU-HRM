...
<div class="modal fade modal-fullscreen" id="demotion" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-full" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="row">
                    @canany(['employee.demotion.icrud', 'employee.demotion.create'])
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group col-sm-12 col-md-4">
                                        ...
                                        <select name="new_unit" style="width:100%;" class="form-control select2"
                                            required="required">
                                            <option value="">..................... </option>
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        ...
                                        <select name="new_job" style="width:100%;" class="form-control select2"
                                            required="required">
                                            <option value="">..................... </option>
                                    ...
                                    <div class="form-group col-sm-12 col-md-12">
                                        <label for=""><i class="la la-user"></i> What is the reason of
                                            {{ $crud?->entry?->name }}'s demotion?</label>
