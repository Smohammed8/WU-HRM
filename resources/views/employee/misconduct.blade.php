...
<div class="modal fade modal-fullscreen" id="decipline" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-full" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="row">
                    @canany(['employee.discipline.icrud', 'employee.discipline.create'])
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <select name="misconduct_type" style="width:100%;" class="form-control select2"
                                        ...
                                        @foreach ($type_of_misconducts as $type_of_misconduct)
                                            <option value="{{ $type_of_misconduct->id }}">
                                                {{ $type_of_misconduct->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <select name="severity" style="width:100%;" id="severity"
                                ...
                                <div class="form-group col-sm-12 col-md-12">
                                    <label for=""><i class="la la-user"></i> Could you tell us the
                                        misceonductivity of {{ $crud->entry->name }}?</label>
                    ...
                    <tbody>
                        ...
                        @foreach ($misconducts as $misconduct)
                            <tr>
                                ...
                                <td>
                                    <button type="button" data-toggle="modal" data-target="#check-in" target="_top"
                                        class="btn  btn-sm btn-outline-primary float-right mr-1"> <i
                                            class="la la-user"></i> View </button>
                                    ...
                                    <a href="" class="btn  btn-sm btn-outline-primary float-right mr-1"><i
                                            class="la la-plus"></i> Add action</a>
                                </td>
                            </tr>
                        @endforeach
                        @if (count($misconducts) == 0)
                            <tr>
                                <td colspan="7" style="color:red;" class="text-center">No employee has
                                    misconducts!</td>
                            </tr>
                        @endif
                    </tbody>
