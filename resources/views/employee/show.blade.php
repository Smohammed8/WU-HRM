                ...
                <div class="row">
                 ...
                 <form method="POST" id="myForm" enctype="multipart/form-data"
                                ...
                                <button type="button" data-value="{{ $crud->entry->id }}" id="save"
                                    class="btn  btn-sm btn-outline-primary float-left mr-1 mt-0" onclick="saveSnap()"> <i
                                        class="fa fa-upload" aria-hidden="true"></i> Save</button>
                        ...
                        <li role="presentation" class="nav-item">
                            <a href="#tab_employee_education" aria-controls="tab_employee_education" role="tab"
                                tab_name="employee_education" data-toggle="tab" class="nav-link "> <i
                                    class="la la-graduation-cap" style="font-size: 20px"> </i> {{ 'Employee Education' }}</a>
                        </li>
                    @endcanany
                        ...
                        <li role="presentation" class="nav-item">
                            <a href="#tab_employee_evaluation" aria-controls="tab_employee_evaluation" role="tab"
                                tab_name="employee_evaluation" data-toggle="tab" class="nav-link "> <i
                                    class="la la-balance-scale" style="font-size: 20px"> </i> {{ 'Employee Efficiency' }}</a>
                        </li>
                    @endcanany
                        ...
                        <table id="crudTable"
                            ...
                            <tbody>
                                ...
                                @if (count($employeeSkills) == 0)
                                    <tr>
                                        <td colspan="4" class="text-left" style="color:red;">No Special skill found!
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                        ...
                        <table id="crudTable"
                            ...
                            <tbody>
                                ...
                                @if (count($employeeLetters) == 0)
                                    <tr>
                                        <td colspan="5" class="text-left" style="color:red;">No employee letter found!
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                        ...
                        <table id="crudTable"
                            ...
                            <tbody>
                                ...
                                @if (count($employeeFamilies) == 0)
                                    <tr>
                                        <td colspan="5" class="text-left" style="color:red;">No Employee Family found!
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                        ...
                        <table id="crudTable"
                            ...
                            <tbody>
                                ...
                                @if (count($internalExperiences) == 0)
                                    <tr>
                                        <td colspan="6" class="text-left" style="color:red;">No Internal Experience
                                            found!</td>
                                    </tr>
                                @endif
                            </tbody>
                        ...
                        <table id="crudTable"
                            ...
                            <tbody>
                                ...
                                @if (count($trainingAndStudies) == 0)
                                    <tr>
                                        <td colspan="8" class="text-left" style="color:red;">No External Experience
                                            found!</td>
                                    </tr>
                                @endif
                            </tbody>
