...
<div class="modal fade modal-fullscreen" id="promotion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                <label for=""><i class="la la-user"></i> What is the reason of {{$crud->entry->name}}'s promotion?</label>
                ...
                <tbody>
                 ...
                 @endforeach
                    @if(count($promotions)==0)
                        <tr>
                            <td colspan="7"  style="color:red;" class="text-center">No employee promotions!</td>
                        </tr>
                    @endif
                </tbody>
              </table>
