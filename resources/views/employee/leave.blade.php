...
<div class="modal fade modal-fullscreen" id="employee_leave" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <tbody>
                    ...
                    @foreach ($leaves as $leave)
                        <tr>
                            ...
                            <td> {{ $leave->status }} </td>
                            <td>
                                <button type="button"  data-toggle="modal" data-id="{{$leave->id}}" data-target="#check-in"  target="_top" class="btn  btn-sm btn-outline-primary float-right mr-1"> <i class="la la-user-plus"></i>  Check-in </button>
                                <a href="javascript:void(0)" data-id="{{$leave->id}}"  class="btn  btn-sm btn-outline-primary float-right mr-1"><i class="la la-edit"></i> Edit</a>
                 ...
                 @endforeach
                    @if(count($leaves)==0)
                        <tr>
                            <td colspan="7"  style="color:red;" class="text-danger text-center">No employee leaves!</td>
                        </tr>
                    @endif
                </tbody>
              </table>
                    ...
                    <form id="" method="POST" action="">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select class="select2 form-control" required="required" name="status"  style="width:100%;">
                            ...
                            <div class="col-md-12">
                              ...
                              <textarea name="comment" placeholder = "Write your comment here..." class="form-control" cols="5" rows="3"> </textarea>
                            </div>
