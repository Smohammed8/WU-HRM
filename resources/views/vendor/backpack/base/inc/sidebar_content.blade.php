...
<!-- //////////////////////////////////////////////////////// -->
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('level') }}'><i class='nav-icon la la-caret-right'></i>Job Levels</a></li>
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('job-grade') }}'><i class='nav-icon la la-caret-right'></i> Job grades</a></li>
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('salary-scale') }}'><i class='nav-icon la la-caret-right'></i> Salary scales</a></li>
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('template') }}'><i class='nav-icon la la-caret-right'></i> Templates</a></li>
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('template-type') }}'><i class='nav-icon la la-caret-right'></i> Template types</a></li>
<!-- /////////////////////////////////////////////////////////////-->
        </ul>
    </li>
    ...
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('form-style') }}'>        <i class='nav-icon la la-caret-right'></i> Efficiency Form style</a></li>
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('form-style') }}'>        <i class='nav-icon la la-caret-right'></i> Employee Form style</a></li>
